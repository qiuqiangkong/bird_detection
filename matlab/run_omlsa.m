function [y,out]=run_omlsa(fin,fout)
...
Fs_ref=44.1e3;		% 1.1) Reference Sampling frequency
M_ref=1024;		% 1.2) Size of analysis window
...
alpha_eta_ref=0.90;	% 4.1) Recursive averaging parameter
